...
def eig_from_samples_varying_sample_size(n_both_candidates_list, proportion, n_rct_before_split, x_distributions, \
    ...
    for length in n_both_candidates_list:
        ...
        sample_func = return_causal_samp_func_linear(X=X_torch,Y=Y_torch,causal_param_first_index=3,mu_0=beta_post_host,sigma_prior = cov_matrix_post_host,
                                            sigma_rand_error = sigma_rand_error,sigma_rand_error_fixed = True)
